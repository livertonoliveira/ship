...
Each sub-agent produces findings per # Ship — Report Templates
...
- Low: X
- **Gate: PASS | WARN | FAIL**
```#finding-entry with the Security audit domain extensions (OWASP, CWE, Vector, Proof of Concept, Effort, Urgent deploy). Categories: `INJ | AUTH | AUTHZ | DATA | CFG | LOGIC | DEPS | PRIV`.
