...
- Bundled references the instructions point at: ${CLAUDE_SKILL_DIR}/patterns/run-scratch.md, ${CLAUDE_SKILL_DIR}/patterns/linear-status.md, ${CLAUDE_SKILL_DIR}/patterns/load-artifacts.md, ${CLAUDE_SKILL_DIR}/patterns/lazy-load-findings.md, ${CLAUDE_SKILL_DIR}/patterns/diff-classifier.md, ${CLAUDE_SKILL_DIR}/patterns/gates.md.
