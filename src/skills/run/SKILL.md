...
- Bundled references the instructions point at: @@ship/patterns/run-scratch.md, @@ship/patterns/linear-status.md, @@ship/patterns/load-artifacts.md, @@ship/patterns/lazy-load-findings.md, @@ship/patterns/gates.md.
